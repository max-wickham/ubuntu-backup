...
The reason that I want to work at Deep Mind is to be able to pursue a career at a company that is not only working on cutting edge technology but technology that can have a significant impact on peoples lives and in many scientific fields. Working at Deep Mind would allow me to work as a Software Engineer whilst still making contributions and building tools that can help scientific development as Deep Mind has shown time and again in fields from molecular biology to neuroscience. Ever since I wrote my first classification program, I have been fascinated by the power of machine learning to solve tasks that I would not have imagined were possible to complete so easily though programming, and I would greatly appreciate the opportunity to learn more about this field and make my own contributions to it. 
