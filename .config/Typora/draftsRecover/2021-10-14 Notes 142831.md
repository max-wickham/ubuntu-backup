...
- Components of learning
  ...
  - Predictors, Models, Hypothesis $$g : X \rightarrow Y$$, $$g$$ aproximates $$f$$
...
- Clustering
  ...
  - Can be Hierachical or Flat, (Hierachical clusters belong to larger sets and so on)
  - Uses
- Anomaly detection
- Dimensionaloty reduction
- Feature Selection
...
- Data has clearly definined input-output pairs

- Predicit outcome, future on unobserved samples
...
- Passive vs active learners
  - Data is given vs learner activly decides which data to use during training
...
## Simple Hypothsesis Class - Linear Predictor
