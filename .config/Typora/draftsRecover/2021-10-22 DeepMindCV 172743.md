...
The reason that I want to work at deepmind is to be able to pursue a career at a company that is not only working on cutting edge technology but technology that can have a significant impact on peoples lives and in many scientific fields. Working at Deep Mind would allow me to work as a Sofware Engineer whilst still making contributions and building tools that can help scietific development as Deep Mind has shown time and again in fields from molecular biology to 
